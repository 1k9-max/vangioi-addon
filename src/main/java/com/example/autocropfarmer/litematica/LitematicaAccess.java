package com.example.autocropfarmer.litematica;
...
final class LitematicaAccess {
     ...
     * schematic doesn't want anything there - air). Used by {@link com.example.autocropfarmer.util.PlacementNavigator}
     ...
     * given up on for now (see {@link com.example.autocropfarmer.util.PlacementNavigator}'s skip-list/watchdog logic -
