...
import com.example.autocropfarmer.util.PlacementNavigator;
...
public class FlyToPlacementModule extends Module {
    ...
    public FlyToPlacementModule() {
        super(AutoCropFarmerAddon.CATEGORY, "fly-to-placement", "Flies to the nearest position missing a block, according to Litematica's schematic overlay.");
