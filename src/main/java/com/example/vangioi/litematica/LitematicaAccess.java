...
final class LitematicaAccess {
     ...
     * schematic doesn't want anything there - air). Used by {@link com.example.vangioi.util.PlacementNavigator}
     ...
     * given up on for now (see {@link com.example.vangioi.util.PlacementNavigator}'s skip-list/watchdog logic -
